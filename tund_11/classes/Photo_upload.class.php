  ...
  class Photoupload {
	...
	public function readExif(){
		...
		if (!empty($exif["DateTimeOriginal"])){
			$this->waterText = $exif["DateTimeOriginal"];
		} else {
			$this->waterText = "Kuupäev puudub";
		}
	}
	...
	public function addText(){
	  ...
	  imagettftext($this->myImage, 20, 0, 10, 25, $textColor, "../vp_picfiles/ARIALBD.TTF", $this->waterText);
	}
